## Welcome to Mark It Up 👋🏻

Mark It Up is a simple **note-taking app** that uses **Markdown** syntax to format your notes.
...
Here are all the heading formats currently supported by **_MarkItUp_**:
